...
## Create Project
```
npm create vite@latest quiz-front -- --template react-ts
```
...
## Installation Composants shadcn/ui
Procédure : https://ui.shadcn.com/docs/installation/vite

Puis ajout des composants de base voulus :
